...
<head>
	...
	<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/helpers.min.css" />
...
<body <?php body_class(); ?> text="gray-90" layout="no-margin no-padding gray-10">

	<!-- not needed? up to you: http://camendesign.com/code/developpeurs_sans_frontieres -->
		<header id="header" role="banner" links="gray-90 no-decoration" layout="h-padding-20 white fix">
			<div layout="max-960 center">
				<h1 text="upper light line-1.5" layout="left v-padding-5 no-margin">
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
						<img text="middle" src="<?php echo bloginfo('template_url') ?>/img/logo-piratas-pr.svg" alt="" width="46" height="46" />
						<?php bloginfo( 'name' ); ?>
					</a>
				</h1>
				<nav id="nav" role="navigation" layout="right">
